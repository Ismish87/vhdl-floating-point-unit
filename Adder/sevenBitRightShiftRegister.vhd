...
ENTITY sevenBitRightShiftRegister IS
	PORT(
...
END sevenBitRightShiftRegister;

ARCHITECTURE rtl OF sevenBitRightShiftRegister IS
	SIGNAL int_Value, int_notValue ,outmux: STD_LOGIC_VECTOR(6 downto 0);
...
BEGIN
  ...
  ZERoFlag <=NOT(int_Value(0) OR int_Value(1) OR int_Value(2) OR int_Value(3) OR int_Value(4) OR int_Value(5) OR int_Value(6) );


mux6 :t2x1MUXmultip port map(i_shift,i_value(6),'0',outmux(6));
